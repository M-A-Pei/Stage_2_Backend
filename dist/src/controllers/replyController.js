...
function findAllInPost(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const x = yield replyService.findAllInPost(Number(req.params.postId));
        res.json(x);
    });
}
function findAllForUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const x = yield replyService.findAllForUser(req.params.username);
        res.json(x);
    });
}
function create(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const x = yield replyService.addReply(req.body);
        res.json(x);
    });
}
